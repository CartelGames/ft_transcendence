...
function printStats(user) {
    ...
    var statsTournament = document.createElement('ul');       
        ...
        attr3.className = 'jsp';
        attr3.textContent = 'une caracteristique en plus à trouver';
        statsTournament.appendChild(attr3);
    var statsLocal = document.createElement('ul');
        var attr = document.createElement('li');
        attr.className = 'nb_game';
        attr.textContent = 'Nombre de Participation en Parties Locale: ' + user.gamesLocalPlayed;
        statsLocal.appendChild(attr);
        var attr2 = document.createElement('li');
        attr2.className = 'game_win';
        attr2.textContent = 'Nombre de Parties Remportées: ' + user.gamesLocalWin;
        statsLocal.appendChild(attr2);
        var attr3 = document.createElement('li');
        attr3.className = 'jsp';
        attr3.textContent = 'une caracteristique en plus à trouver';
        statsLocal.appendChild(attr3);
